...
class Facturepay extends Component
{
// Filtres et état UI
    ...
    public function mount(): void
    {
        ...
        $cands = [
            ['id'=>1,'name'=>auth()->user()->lastname.''.auth()->user()->firstname,'email'=>'mbelolo@example.com'],
            ['id'=>2,'name'=>auth()->user()->lastname.''.auth()->user()->firstname,'email'=>'nadia@example.com'],
            ['id'=>3,'name'=>auth()->user()->lastname.''.auth()->user()->firstname,'email'=>'ruben@example.com'],
        ...
        $this->invoices = [
            ...
            $make(5,$cands[1], 90000, 90000,now()->subDays(1)->toDateString(),   now()->addDays(5)->toDateString(),'mtn'),
            $make(6,$cands[2],110000,      0,now()->toDateString(),              now()->addDays(7)->toDateString(),'bank'),
    ...
    public function render()
    {
        ...
        return view('livewire.candidat.facturepay',compact('invoices','stats'))
