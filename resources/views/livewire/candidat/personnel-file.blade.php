            ...
            <div class="card mt-3">
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade active show">
                            <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
                                ...
                                <div class="btn-group" role="group" aria-label="Filter">
                                    ...
                                    <button class="btn btn-outline-warning {{ $invoiceFilter==='pending'?'active':'' }}"
                                            wire:click="setInvoiceFilter('pending')">En attente</button>
                        ...
                        @if($tab==='modules')
                        <div class="tab-pane fade active show">
                            <h5 class="mb-3">Modules inscrits</h5>
                            <div class="table-responsive">
                                <table class="table table-hover table-striped align-middle">
                                    ...
                                    @forelse($modules as $i => $m)
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a href="{{ route('modules.show', $m->id) }}" class="btn btn-sm btn-outline-primary">
                                                    Ouvrir
                                                </a>
                                            </td>
                                        </tr>
