                    ...
                    <div class="table-responsive">
                        <table class="table table-nowrap table-borderless mb-0">
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row"><i class="mdi mdi-school text-primary me-2"></i> Niveau :</th>
                                    <td>{{ $data->level }}</td>
                                </tr>
                                <tr>
                                    <th scope="row"><i class="mdi mdi-google-maps text-primary me-2"></i> Adresse :</th>
                                    <td>{{ $data->addrese }}</td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1 ms-3">
                                    <p class="text-muted fw-medium mb-2">Module disponible</p>
                                    <h4 class="mb-0">0</h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <div class="nav nav-lines mb-0" id="nav1-tab" role="tablist">
                                <a class="nav-item nav-link {{ ($show == 'liste_nv')?'active':'' }}" href="#" wire:click.prevent="tabs('liste_nv')">Facture</a>
                                <a class="nav-item nav-link {{ ($show == 'liste_ap')?'active':'' }}" href="#" wire:click.prevent="tabs('liste_ap')">Module accessible</a>
