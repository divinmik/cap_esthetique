    ...
    <div class="col-12">
        <div class="card" style="height: 495px; overflow: hidden auto;" data-simplebar="">
            <div class="card-header">
                ...
                <h3 class="card-title">Inscription en attente de confirmation de paiement <div class="avatar avatar-primary avatar-circle avatar-xs">
                    ...
                    <table id="datatable-buttons" class="table text-nowrap mb-0">
                       <thead class="bg-gray-50">
                        ...
                        @forelse($candidates as $key=>$candidate)
                            ...
                            <td class="">{{ $candidate->birthdate->format('d/m/Y') }}</td>
