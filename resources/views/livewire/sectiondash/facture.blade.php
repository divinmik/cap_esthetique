          ...
          <div class="row g-3">
            <div class="col-md-5">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control border-start-0 ps-0" placeholder="N° facture, nom, email..."
                  ...
                  <td class="text-end">
                    <div class="btn-group" role="group">
                      ...
                      <ul class="dropdown-menu dropdown-menu-end shadow">
                        <li>
                          <a class="dropdown-item" href="#" wire:click.prevent="addPayment({{ $inv['id'] }}, 50000)">
                        ...
                        <li>
                          <a class="dropdown-item" href="#" wire:click.prevent="sendReminder({{ $inv['id'] }})">
                            <svg width="14" height="14" fill="currentColor" class="me-2" viewBox="0 0 16 16">
                        ...
                        <li>
                          <a class="dropdown-item text-danger" href="#" wire:click.prevent="delete({{ $inv['id'] }})">
                            <svg width="14" height="14" fill="currentColor" class="me-2" viewBox="0 0 16 16">
