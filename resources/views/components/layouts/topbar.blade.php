     ...
     <div class="navbar-header">
         ...
         <div class="navbar-logo-box">
             <a href="" class="logo logo-dark">
                 <span class="logo-sm">
                     <img src="/admin/assets/images/logo-sm.png" alt="logo-sm-dark" height="20">
                 </span>
                 <span class="logo-lg">
                     <img src="/admin/assets/images/logo-dark.png" alt="logo-dark" height="18">
                 </span>
             </a>

             <a href="" class="logo logo-light">
                 <span class="logo-sm">
                     <img src="/admin/assets/images/logo-sm.png" alt="logo-sm-light" height="20">
                 </span>
                 <span class="logo-lg">
                     <img src="/admin/assets/images/logo-light.png" alt="logo-light" height="18">
                 </span>
             </a>
             ...
             <div class="d-flex align-items-center gap-2">
                     ...
                     <div class="dropdown-menu dropdown-menu-lg dropdown-menu-md dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                         <div class="p-3 bg-info">
                             <div class="row align-items-center">
                                 ...
                                 <div class="col-auto">
                                     <a href="/#!" class="badge bg-info-subtle text-info"> 0</a>
                                 </div>
                             </div>
                         </div>
                 ...
                 <div class="dropdown d-inline-block">
                     <button type="button" class="btn btn-sm top-icon p-0" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        @php
                        $fille = str_replace('profils/', '', auth()->user()->profile_photo_path);
                        @endphp  
                        <img class="rounded avatar-2xs p-0" src="{{ route('docs.display', ['filename' => $fille]) }}" alt="Header Avatar">
                     </button>
                             ...
                             <div class="card-header bg-primary rounded-0">
                                 <div class="rich-list-item w-100 p-0">
                                     ...
                                     <div class="rich-list-content">
                                         <h3 class="rich-list-title text-white">{{ auth()->user()->firstname }} {{ auth()->user()->lastname }}</h3>
                                         <span class="rich-list-subtitle text-white">{{ auth()->user()->email }} / {{ auth()->user()->phone }}</span>
                                     </div>
                             ...
                             <div class="card-body p-0">
                                 <div class="grid-nav grid-nav-flush grid-nav-action grid-nav-no-rounded">
                                     <div class="grid-nav-row">
                                        ...
                                        @endphp
                                         <a href="{{ route($url??'dash') }}" class="grid-nav-item">
